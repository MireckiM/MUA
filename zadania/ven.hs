...
--------------------------------------------------------------------------------intro
ch1 = Modify (Transpose 3) (chord [g 1 (1/2), g 1 (1/2)])
s1 = Modify (Transpose 3) (g 4 (1/2))

introp1 = line [ch1,s1,ch1,s1,ch1,s1,ch1,s1]

ch2 = Modify (Transpose 3) (chord [f 1 (1/2), f 1 (1/2)])

introp2 = line [ch2,s1,ch2,s1,ch2,s1,ch2,s1]

ch3 = Modify (Transpose 3) (chord [c 1 (1/2), c 1 (1/2)])

introp3 = line[ch3,s1,ch3,s1,ch3,s1,ch3,s1]

ch4 = Modify (Transpose 1) (chord [c 1 (1/2), c 1 (1/2)])
ch5 = Modify (Transpose 0) (chord [c 1 (1/2), c 1 (1/2)])
s41 = Modify (Transpose 1) (chord [c 1 (1/4), c 1 (1/4)])
s42 = Modify (Transpose 0) (chord [c 1 (1/4), c 2 (1/4)])
s43 = Modify (Transpose 0) (chord [c 1 (1/4), c 1 (1/4)])
...
brimain = Modify (Tempo 1.5) ((retro bri) :+: bri :+: (retro bri) :+: bri2 :+: bri2 :=: bri2g)
...
mainmusicnew = intro :+: (introsh :=: ambientintro2 :=: lnsh :=: looppbeg) :+: (introsh :=: ambientintro :=: lnsh :=: looppfin) :+: (phrase [ Tmp $ Accelerando 1.5] (lnshguitar :=: ambientintro)) :+: Modify (Tempo 1.5) (introsh :=: ambientintro :=: lnsh :=: looppmed :=: lnguitar ) :+: Modify (Tempo 1.6) (introsh :=: ambientintro :=: lnsh :=: looppfin :=: lnguitar :=: lnn )


sumain = Modify (Tempo 1.4) mainmusicnew
